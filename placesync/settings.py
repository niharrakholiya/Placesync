"""
Django settings for placesync project.
...
SECRET_KEY = 'django-insecure-srgv+$0@-8u1!0$#2ft5a5y+4f02u&b$^=+4bu+ke*$yd$d+ik'
...
WSGI_APPLICATION = 'placesync.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    # Remove the CommonPasswordValidator and NumericPasswordValidator
    {
...
AUTH_USER_MODEL = 'authentication.BasicUser'
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Define the URL prefix where uploaded media files will be served
MEDIA_URL = '/media/'
